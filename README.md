...
Выбираем что нам удобно. В моем случае это генерация графа путем ручного ввода. И вводим сам граф. Если выбрать автоматическое заполнение графа, программа запросит минимальное и максимальное значение графа.
...
* [`kartinki`](https://github.com/sorogin-ivan/Laba4/tree/master/kartinki) - директория с картинками для отчета;
